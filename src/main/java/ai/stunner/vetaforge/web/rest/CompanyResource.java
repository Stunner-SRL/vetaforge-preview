...
import ai.stunner.vetaforge.service.CompanyService;
...
/**
 * REST controller for managing {@link ai.stunner.vetaforge.domain.Company}.
 */
@RestController
@RequestMapping("/api")
public class CompanyResource {
    ...
    private static final String ENTITY_NAME = "rbroCompany";
    ...
    public ResponseEntity<Company> updateCompany(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, company.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<Company> partialUpdateCompany(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, company.getId())
        );
    }
