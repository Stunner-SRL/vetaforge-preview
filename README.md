...
This is the microservice used for Stunner VetaForge.
It contains the core heart for the VetaForge and it manages the worflows used for data orchestration.
...
To build the final jar and optimize the rbro application for production, run:
